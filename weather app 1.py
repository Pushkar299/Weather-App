...
#key: 134a0fa436d74ecc68bf8d7420b1bd4d
...
def get_weather(city):
    weather_key='134a0fa436d74ecc68bf8d7420b1bd4d'
...
heading_title=tk.Label(bg_lbl,text='Earth including over 200,000 cities!',fg='red',bg='sky blue',font=('times now roman',18,'bold'))
...
frame_two=tk.Frame(bg_lbl,bg="white",bd=5)
